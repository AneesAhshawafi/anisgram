            ...
            <div class="space-y-12">
                <div class="border-b border-gray-200 dark:border-white/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            <label for="username"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Username') }}</label>
                            <div class="mt-2">
                                <div class="flex items-center rounded    ">
                                    ...
                                    <input id="username" type="text" name="username" placeholder="janesmith"
                                        class="block min-w-0 grow rounded-md bg-white dark:bg-transparent border border-gray-300 dark:border-transparent py-1.5 rtl:pr-1 rtl:pl-3 ltr:pl-1 ltr:pr-3 text-base text-gray-900 dark:text-white placeholder:text-gray-500 focus:outline focus:outline-0 sm:text-sm/6"
                                        value="{{ $user->username }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-full">
                            <label for="about"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Bio') }}</label>
                            <div class="mt-2">
                                <textarea id="bio" name="bio" rows="3"
                                    class="block w-full rounded-md bg-white dark:bg-white/5 px-3 py-1.5 text-base text-gray-900 dark:text-white border border-gray-300 dark:border-transparent outline outline-1 -outline-offset-1 outline-gray-300 dark:outline-white/10 placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">{{ $user->bio }}</textarea>
                            </div>
                        ...
                        <div class="col-span-full">
                            <label for="photo"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Photo') }}</label>
                            ...
                            <div class="flex text-gray-900 dark:text-white items-center gap-x-3 mt-3  ">
                            ...
                            <div class="sm:col-span-3">
                                <label for="lang"
                                    class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Language') }}</label>
                                <div class="mt-2">
                                    <select id="lang" name="lang"
                                        class="block w-full rounded-md bg-white dark:bg-white/5 px-3 py-1.5 text-base text-gray-900 dark:text-white border border-gray-300 dark:border-transparent outline outline-1 -outline-offset-1 outline-gray-300 dark:outline-white/10 focus:outline focus:outline-2 focus:outline-indigo-500 sm:text-sm/6 [&>option]:bg-white dark:[&>option]:bg-gray-800 [&>option]:text-gray-900 dark:[&>option]:text-white">
                                        <option value="ar"
                                            {{ old('lang', $user->lang ?? app()->getLocale()) == 'ar' ? 'selected' : '' }}>
                                            العربية</option>
                                        <option value="en"
                                            {{ old('lang', $user->lang ?? app()->getLocale()) == 'en' ? 'selected' : '' }}>
                                            English</option>
                                    </select>
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                                <label for="theme"
                                    class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Theme') }}</label>
                                <div class="mt-2">
                                    <select id="theme" name="theme"
                                        class="block w-full rounded-md bg-white dark:bg-white/5 px-3 py-1.5 text-base text-gray-900 dark:text-white border border-gray-300 dark:border-transparent outline outline-1 -outline-offset-1 outline-gray-300 dark:outline-white/10 focus:outline focus:outline-2 focus:outline-indigo-500 sm:text-sm/6 [&>option]:bg-white dark:[&>option]:bg-gray-800 [&>option]:text-gray-900 dark:[&>option]:text-white">
                                        <option value="light"
                                            {{ old('theme', $user->theme ?? 'light') == 'light' ? 'selected' : '' }}>
                                            {{ __('Light') }}</option>
                                        <option value="dark"
                                            {{ old('theme', $user->theme ?? 'light') == 'dark' ? 'selected' : '' }}>
                                            {{ __('Dark') }}</option>
                                        <option value="system"
                                            {{ old('theme', $user->theme ?? 'light') == 'system' ? 'selected' : '' }}>
                                            {{ __('System') }}</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="border-b border-gray-200 dark:border-white/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="name"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Name') }}</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-4">
                            <label for="email"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Email address') }}</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            <label for="password"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Password') }}</label>
                            <div class="mt-2 relative">
                                <input id="password" type="password" name="password" autocomplete="new-password"
                                    class="block w-full rounded-md bg-white dark:bg-white/5 px-3 py-1.5 rtl:pl-10 ltr:pr-10 text-base text-gray-900 dark:text-white border border-gray-300 dark:border-transparent outline outline-1 -outline-offset-1 outline-gray-300 dark:outline-white/10 focus:outline focus:outline-2 focus:outline-indigo-500 sm:text-sm/6" />
                                ...
                                <button type="button"
                                    ...
                                    class="absolute inset-y-0 rtl:left-0 rtl:pl-3 ltr:right-0 ltr:pr-3 flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <div class="sm:col-span-2">
                            <label for="password_confirmation"
                                class="block text-sm/6 font-medium text-gray-900 dark:text-white">{{ __('Confirm Password') }}</label>
                            <div class="mt-2 relative">
