            ...
            <div class="space-y-12">
                <div class="border-b border-white/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            <label for="username"
                                class="block text-sm/6 font-medium text-white">{{ __('Username') }}</label>
                            <div class="mt-2">
                                <div class="flex items-center rounded    ">
                                    ...
                                    <input id="username" type="text" name="username" placeholder="janesmith"
                                        class="block min-w-0 grow rounded-md bg-transparent py-1.5 rtl:pr-1 rtl:pl-3 ltr:pl-1 ltr:pr-3 text-base text-white placeholder:text-gray-500 focus:outline focus:outline-0 sm:text-sm/6"
                                        value="{{ $user->username }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-full">
                            <label for="about"
                                class="block text-sm/6 font-medium text-white">{{ __('Bio') }}</label>
                            <div class="mt-2">
                            ...
                            <p class="mt-3 text-sm/6 text-gray-400">{{ __('Write a few sentences about yourself.') }}
                            </p>
                        </div>

                        <div class="col-span-full">
                            <label for="photo"
                                class="block text-sm/6 font-medium text-white">{{ __('Photo') }}</label>
                            ...
                            <div class="sm:col-span-3">
                                <label for="lang"
                                    class="block text-sm/6 font-medium text-white">{{ __('Language') }}</label>
                                <div class="mt-2">
                                    <select id="lang" name="lang"
                                        class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline outline-1 -outline-offset-1 outline-white/10 focus:outline focus:outline-2 focus:outline-indigo-500 sm:text-sm/6 [&>option]:bg-gray-800 [&>option]:text-white">
                                        <option value="ar"
                ...
                <div class="border-b border-white/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label for="email"
                                class="block text-sm/6 font-medium text-white">{{ __('Email address') }}</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2 relative">
                                <input id="password" type="password" name="password" autocomplete="new-password"
                                    class="block w-full rounded-md bg-white/5 px-3 py-1.5 rtl:pl-10 ltr:pr-10 text-base text-white outline outline-1 -outline-offset-1 outline-white/10 focus:outline focus:outline-2 focus:outline-indigo-500 sm:text-sm/6" />
