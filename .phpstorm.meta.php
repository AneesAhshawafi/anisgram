...
'broadcasting.connections.null.driver','view.paths','view.compiled','images.default','hashing.driver',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'dashboard','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','profile.edit','profile.update','profile.destroy',
'home','create_post','store_post','show_post','edit_post',
'update_post','delete_post','explore','like_post','store_comment',
'user_profile','edit_user_profile','update_user_profile','follow_user','unfollow_user',
...
'auth.verify-email','components.application-logo','components.auth-session-status','components.button','components.create-edit-form',
'components.danger-button','components.dropdown','components.dropdown-link','components.input-error','components.input-label',
'components.modal','components.nav-link','components.post','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','dashboard','layouts.app','layouts.guest',
'layouts.navigation','posts.create','posts.edit','posts.explore','posts.index',
'posts.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'user.edit','user.profile','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
